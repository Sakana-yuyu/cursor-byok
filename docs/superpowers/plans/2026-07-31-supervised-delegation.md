...
- [ ] Step 1: Define stable enums and limits.
...
- [ ] Step 2: Define immutable task contract and checkpoint types.
...
- [ ] Step 3: Add supervisor fields to scheduler snapshots without leaking data.
...
- [ ] Step 4: Add non-blocking checkpoint publication.
...
- [ ] Step 5: Run formatting and compile verification.
...
- [ ] Step 1: Define issue codes and detector input.
...
- [ ] Step 2: Implement repeated-action detection.
...
- [ ] Step 3: Implement no-progress and error recovery detection.
...
- [ ] Step 4: Implement scope and completion-evidence checks.
...
- [ ] Step 5: Verify detector behavior with existing command-level checks.
...
- [ ] Step 1: Add runtime supervisor configuration mapping.
...
- [ ] Step 2: Build a coordinator state machine around the existing scheduler.
...
- [ ] Step 3: Add strict supervisor provider calls.
...
- [ ] Step 4: Apply decisions with isolation and circuit breaking.
...
- [ ] Step 5: Validate every asynchronous callback.
...
- [ ] Step 6: Close the coordinator with the service lifecycle.
...
- [ ] Step 7: Compile and inspect lifecycle logs.
...
- [ ] Step 1: Add persisted configuration fields with backward-compatible defaults.
...
- [ ] Step 2: Map persisted configuration to runtime config.
...
- [ ] Step 3: Extend the sanitized runtime DTO.
...
- [ ] Step 4: Add binding methods using the existing API style.
...
- [ ] Step 5: Verify persistence and DTO safety.
...
- [ ] Step 1: Add supervision settings section.
...
- [ ] Step 2: Wire real load/save/error/busy states.
...
- [ ] Step 3: Display supervision runtime state.
...
- [ ] Step 4: Verify UI through the running app.
...
- [ ] Step 3: Exercise disabled-mode compatibility.
...
- [ ] Step 4: Exercise supervised success and partial success.
...
- [ ] Step 5: Exercise correction, reassignment, escalation, and circuit breaking.
...
- [ ] Step 6: Exercise cancellation and stale-event safety.
...
- [ ] Step 7: Review code boundaries and secrets.
...
- [ ] Step 8: Record acceptance and commit.
