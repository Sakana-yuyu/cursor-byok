...
const executors = [
  ...
  { id: "kiro-cli", displayName: "Kiro CLI", installURL: "https://cli.kiro.dev/install", enabled: false, priority: 35, state: "not_installed", installed: false, authState: "unknown", diagnosticCode: "kiro_not_installed", diagnosticText: "未检测到 Kiro CLI；安装地址：https://cli.kiro.dev/install" },
...
test("紧凑展示执行器健康、版本与 Cursor 编辑器限定状态", async ({ page }) => {
  ...
  await expect(installLinks.nth(1)).toHaveAttribute("href", "https://cli.kiro.dev/install");
