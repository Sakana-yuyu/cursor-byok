...
export const fieldTips = {
  ...
  reasoningEffort: "渠道允许的推理强度上限。客户端选择低于上限时保留客户端值，选择高于上限时自动限制到这里；越高通常越稳，但也可能更慢。",
  ...
  anthropicThinkingEffort: "Anthropic adaptive thinking 的思考强度上限。客户端选择高于上限时会自动限制，请求固定使用新版 thinking.type=adaptive。",
