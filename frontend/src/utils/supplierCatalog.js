...
const catalogRows = [
  ...
  ["unity2", "Unity2.ai", "anthropic", "https://unity2.ai", "https://unity2.ai/register?source=ccs", "https://api.unity2.ai/v1", [], {}],
  ["shengsuanyun", "胜算云", "anthropic", "https://www.shengsuanyun.com/?from=CH_4HHXMRYF", "https://www.shengsuanyun.com/?from=CH_4HHXMRYF", "https://router.shengsuanyun.com/api", ["anthropic/claude-sonnet-5", "anthropic/claude-opus-5", "anthropic/claude-haiku-4.5"], {}],
  ...
  ["ucloud", "优云智算", "anthropic", "https://www.compshare.cn", "https://www.compshare.cn/coding-plan", "https://api.modelverse.cn/v1", [], {}],
  ["ucloud_coding", "优云智算 Coding Plan", "anthropic", "https://www.compshare.cn", "https://www.compshare.cn/coding-plan", "https://cp.compshare.cn/v1", [], {}],
  ...
  ["qiniu", "七牛云", "anthropic", "https://s.qiniu.com/nMvAvy", "https://s.qiniu.com/nMvAvy", "https://api.qnaigc.com/v1", [], { modelCatalogURLs: ["https://api.qnaigc.com/v1/models", "https://api.modelink.ai/v1/models"] }],
...
const supplierRows = catalogRows.map(([id, label, type, websiteURL, apiKeyURL, baseURL, models, options]) =>
...
export function supplierSelectOptions(currentID = "") {
  const options = SUPPLIER_TEMPLATES.map(({ id, label }) => ({ value: id, label }));
  ...
  if (compatibilityTemplates.has(normalizedID)) {
    ...
    options.push({ value: compatibility.id, label: compatibility.label });
  }
  return options;
}
