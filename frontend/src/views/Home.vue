...
import { appState, appViewState, getCursorManualPath, openModelConfigWindow, openMetricsDetailWindow, openRequestMetricsWindow, openLocalLogsDirectory, exportLogsAction, repairProxyAction, restartCursorAction, saveRoutingMode, syncServiceState, toUserError, toggleService } from "@/state/appState";
...
async function handleRestartCursor() {
