...
import { getCARepairStatus, launchCursor, openRequestMetricsWindow } from "@/services/clientApi";
...
async function handleOpenRequestMetrics() {
  ...
  try {
    await openRequestMetricsWindow();
  } catch (error) {
